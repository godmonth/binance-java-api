...
public interface BinanceApiService {
    @POST("/gateway-api/v1/public/ocbs/user/register")
    Call<UserRegisterResponse> ocbsUserRegister(@Body UserRegisterRequest userRegisterRequest);
    ...
    Call<WithdrawResult> withdraw(@Query("withdrawOrderId") String withdrawOrderId,@Query("asset") String asset, @Query("address") String address, @Query("amount") String amount, @Query("name") String name, @Query("addressTag") String addressTag,
                                  @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)
    @POST("/sapi/v1/capital/withdraw/apply")
    Call<WithdrawResult> withdraw2(@Query("withdrawOrderId") String withdrawOrderId,@Query("coin") String coin, @Query("address") String address, @Query("amount") String amount, @Query("name") String name, @Query("addressTag") String addressTag,
                                  @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
