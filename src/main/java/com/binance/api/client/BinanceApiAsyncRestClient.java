...
public interface BinanceApiAsyncRestClient {
   ...
   */
  void withdraw(String withdrawOrderId,String asset, String address, String amount, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback);
